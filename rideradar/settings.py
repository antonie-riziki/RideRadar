"""
Django settings for rideradar project.
...
SECRET_KEY = 'django-insecure-m2ap@-x6z%lz5$hll$*=mflr0lj27h1_xeqz%#5=w1)ve#=@@a'
...
ROOT_URLCONF = 'rideradar.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [r'rideradar_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'rideradar.wsgi.application'
